        ...
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          ...
          <aside>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="my-2 bg-slate-200 p-2 font-bold">
                contact@newteksolutions.com
              </p>

              <h3 className="text-xl">Contact Phone:</h3>

              <p className="my-2 bg-slate-200 p-2 font-bold">555-555-5555</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
              <button
                className="bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
              >
                Delete Job
              </button>
            </div>
